...
claim to be verified, not a result to be trusted.

**Start here**
- [MobHunt](https://github.com/ivRodriguezCA/MobHunt): agents plus strict validation gates for mobile bug bounty; Claude Code today, Codex CLI support in progress (2026)
